          ...
          <div style={{ background: '#0A0805', borderRadius: 12, overflow: 'hidden', border: '1px solid rgba(201,168,76,0.1)' }}>
            ...
            <div style={{ padding: 0, fontFamily: 'Georgia, serif' }}>
              ...
              <div style={{ padding: '24px 40px', background: '#120F0C', borderBottom: '1px solid rgba(201,168,76,0.06)' }}>
                ...
                <div style={{ display: 'flex', gap: 32 }}>
                  <div><p style={{ margin: '0 0 2px', fontSize: 10, color: '#5A5550' }}>Satış Adedi</p><p style={{ margin: 0, fontSize: 20, fontWeight: 300, color: '#EDE8DF' }}>{form.site_adet || '—'} <span style={{ fontSize: 11, color: '#7A7468' }}>adet</span></p></div>
                  <div><p style={{ margin: '0 0 2px', fontSize: 10, color: '#5A5550' }}>Ciro</p><p style={{ margin: 0, fontSize: 20, fontWeight: 300, color: '#EDE8DF' }}>{fmt(parseFloat(form.site_tutar) || 0)} <span style={{ fontSize: 11, color: '#7A7468' }}>TL</span></p></div>
                </div>
              </div>
              {/* Durum */}
              {form.durum && (
